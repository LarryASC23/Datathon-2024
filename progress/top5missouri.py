...
for year in range(1993, 2024):
    ...
    sample_id_prefix = f'MO{year_suffix}'
...
for year, (pesticide, count) in yearly_pesticide_counts.items():
    print(f"The most common pesticide in Missouri  in {year} is '{pesticide}' with {count} occurrences.")

# Display the top 5 most common pesticides across all years
print("\nThe top 5 most common pesticides in Missouri  from 1993 to 2023 are:")
