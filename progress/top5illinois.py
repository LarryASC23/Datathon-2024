...
for year in range(1993, 2024):
    ...
    sample_id_prefix = f'IL{year_suffix}'
...
for year, (pesticide, count) in yearly_pesticide_counts.items():
    print(f"The most common pesticide in iLLINOIS in {year} is '{pesticide}' with {count} occurrences.")

# Display the top 5 most common pesticides across all years
print("\nThe top 5 most common pesticides in ILLINOIS from 1993 to 2023 are:")
